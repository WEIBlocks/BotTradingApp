...
const styles = StyleSheet.create({
  ...
  metricLabel: {fontFamily: 'Inter-Medium', fontSize: 10, letterSpacing: 0.8, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', marginBottom: 6},
  metricValue: {fontFamily: 'Inter-Bold', fontSize: 26, letterSpacing: -0.5},
  metricSub: {fontFamily: 'Inter-Regular', fontSize: 11, color: 'rgba(255,255,255,0.5)', marginTop: 2},
  ...
  ctaCaption: {fontFamily: 'Inter-Medium', fontSize: 11, letterSpacing: 1, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', marginBottom: 4},
  ...
  noLockText: {fontFamily: 'Inter-Medium', fontSize: 10, letterSpacing: 0.8, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase'},
  ...
  reviewSubtitle: {fontFamily: 'Inter-Regular', fontSize: 13, color: 'rgba(255,255,255,0.55)', textAlign: 'center', marginBottom: 16},
