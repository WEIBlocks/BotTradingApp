...
const styles = StyleSheet.create({
  ...
  subtitle: {fontFamily: 'Inter-Regular', fontSize: 14, color: 'rgba(255,255,255,0.5)', lineHeight: 20, marginBottom: 12},
  liveIndicator: {flexDirection: 'row', alignItems: 'center', marginBottom: 16, gap: 8},
  liveDot: {width: 8, height: 8, borderRadius: 4, backgroundColor: '#10B981'},
  liveText: {fontFamily: 'Inter-Medium', fontSize: 12, color: 'rgba(255,255,255,0.45)', letterSpacing: 0.3},
  ...
  shadowStatLabel: {fontFamily: 'Inter-Regular', fontSize: 11, color: 'rgba(255,255,255,0.5)', marginTop: 1},
  winRateRow: {flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10},
  winRateLabel: {fontFamily: 'Inter-Regular', fontSize: 11, color: 'rgba(255,255,255,0.45)', width: 54},
  ...
  actionBtnPauseText: {fontFamily: 'Inter-SemiBold', fontSize: 13, color: 'rgba(255,255,255,0.75)'},
  actionBtnStop: {
    flex: 1, height: 38, borderRadius: 10, alignItems: 'center', justifyContent: 'center',
