...
const styles = StyleSheet.create({
  ...
  codeLabel: {fontFamily: 'Inter-Medium', fontSize: 11, letterSpacing: 1, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', marginBottom: 8},
  ...
  sectionLabel: {fontFamily: 'Inter-Medium', fontSize: 11, letterSpacing: 1, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', marginBottom: 12},
  ...
  shareLabel: {fontFamily: 'Inter-Medium', fontSize: 11, color: 'rgba(255,255,255,0.6)'},
  ...
  timelineSubtitle: {fontFamily: 'Inter-Regular', fontSize: 12, color: 'rgba(255,255,255,0.5)'},
