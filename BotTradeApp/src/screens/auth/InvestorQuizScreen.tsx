...
const styles = StyleSheet.create({
  ...
  stepPercent: {fontFamily: 'Inter-Medium', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginTop: 2},
  ...
  optionSubtitle: {fontFamily: 'Inter-Regular', fontSize: 12, color: 'rgba(255,255,255,0.5)', marginTop: 2},
  ...
  goalLabel: {fontFamily: 'Inter-Medium', fontSize: 13, color: 'rgba(255,255,255,0.6)'},
