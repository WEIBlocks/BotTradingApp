...
export const trades = pgTable("trades", {
    ...
    userId: uuid("user_id")
        .notNull()
        .references(() => users.id),
    botSubscriptionId: uuid("bot_subscription_id").references(() => botSubscriptions.id),
    ...
    userExecutedIdx: index("trades_user_executed_idx").on(t.userId, t.executedAt),
    subExecutedIdx: index("trades_sub_executed_idx").on(t.botSubscriptionId, t.executedAt),
}));
