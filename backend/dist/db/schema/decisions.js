...
export const botDecisions = pgTable("bot_decisions", {
    id: uuid("id")
        .primaryKey()
    ...
    userCreatedIdx: index("bot_decisions_user_created_idx").on(t.userId, t.createdAt),
    botCreatedIdx: index("bot_decisions_bot_created_idx").on(t.botId, t.createdAt),
}));
