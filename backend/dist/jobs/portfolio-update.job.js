 ...
 */
async function syncConnectionBalances(conn) {
    ...
    try {
        ...
        const priceMap = new Map(); // currency → USD price
 ...
 */
async function repriceCachedAssets(conn) {
 ...
 */
export async function refreshUserPortfolio(userId) {
    try {
