...
export const creatorAnalytics = pgTable(
  ...
  (t) => ({
    creatorDateIdx: index("creator_analytics_creator_date_idx").on(
      t.creatorId,
      t.date
    ),
  })
...
export const botExperiments = pgTable(
  "bot_experiments",
  {
    id: uuid("id")
      .primaryKey()
...
export const userBotProfitability = pgTable(
  "user_bot_profitability",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (t) => ({
    ...
    userBotUnique: unique("user_bot_profitability_user_bot_unique").on(
      t.userId,
      t.botId
    ),
  })
...
export const botPatternAnalysis = pgTable(
  "bot_pattern_analysis",
  {
    id: uuid("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
